...
def test_coarse_role_gates_are_documented_as_deprecated(gate_name):
    ...
    # assertions. They keep working here (remaining call sites: auth.py,
    # attendance.py are out of scope for this task; schedules/departments/
    # positions/locations/settings/faces and employees create/update/delete
    # have already been migrated off them) but must be clearly marked
